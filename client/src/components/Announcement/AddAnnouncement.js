...
export const AddAnnouncement = () => {
    ...
    const [announcementData, setAnnouncementData] = useState({ title: '', body: '', attachments: [] });

    const handleChange = (e) => {
        setAnnouncementData(p => ({ ...p, [e.target.name]: e.target.value }));
    }
        ...
        <div className="container-add-announcement">
            ...
            <div className={"add-announcement-board"}>
                <div className={"announcement-info-board"}>
                    ...
                    <input value={announcementData.title} onChange={handleChange} name="title" className={"announcement-info-text"}/>
                    <h1 className={"announcement-info-title"}>Текст</h1>
                    <textarea value={announcementData.body} onChange={handleChange} name="body" className={"announcement-info-text"}></textarea>
                </div>
